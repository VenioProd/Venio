...
const vatDeclarationSchema = new mongoose.Schema(
  {
    ...
    totalDue: { type: Number, default: 0 },           // = collectée - déductible - crédit antérieur (>0 à payer, <0 crédit)
    ...
    submittedRef: { type: String, default: '' },      // n° de télédéclaration impots.gouv
...
export default mongoose.model('VatDeclaration', vatDeclarationSchema)
