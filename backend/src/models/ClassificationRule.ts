...
const ruleConditionSchema = new mongoose.Schema<IRuleConditions>(
  {
...
const ruleMappingSchema = new mongoose.Schema<IRuleMapping>(
  {
...
const classificationRuleSchema = new mongoose.Schema<IClassificationRule>(
  {
...
export default mongoose.model<IClassificationRule>('ClassificationRule', classificationRuleSchema)
