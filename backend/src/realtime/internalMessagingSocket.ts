...
import { canAccessConversation, createMessage, markConversationRead } from '../services/internalMessaging.js'
  ...
  io.on('connection', (socket) => {
    ...
    socket.on('typing:start', ({ conversationId }: { conversationId: string }) => {
      socket
        ...
        .emit('typing:start', { conversationId, userId: user.id, name: user.name })
    })
