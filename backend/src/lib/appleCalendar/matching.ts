 ...
 */
export function matchEventToClass(event: MatchInput, classes: ClassCandidate[]): MatchedClass | null {
  ...
  for (const klass of classes) {
    ...
    const classTokens = uniqueTokenSet([klass.name, klass.school, klass.program, klass.level, ...(klass.tags || [])])
