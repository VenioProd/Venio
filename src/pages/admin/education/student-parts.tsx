...
export function QuickAddStudent({ classId, onClose, onSaved }: { classId: string; onClose: () => void; onSaved: () => void }) {
...
export function CsvImport({ classId, onClose, onImported }: { classId: string; onClose: () => void; onImported: () => void }) {
