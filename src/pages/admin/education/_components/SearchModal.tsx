...
import { searchEducation, studentDisplayName, formatDate } from '@/services/education'
...
export default function SearchModal({
  ...
  const [results, setResults] = useState<
    Awaited<ReturnType<typeof searchEducation>>['results'] | null
  >(null)
            ...
            <>
              ...
              {results.students.map(s => (
                <div
                  ...
                  className="edu-search-result"
                  onClick={() =>
                    typeof s.classId !== 'string' && onPickClass(s.classId._id)
                  }
                >
              ...
              {results.assignments.map(a => (
                <div
                  ...
                  className="edu-search-result"
                  onClick={() =>
                    typeof a.classId !== 'string' && onPickClass(a.classId._id)
                  }
                >
                  {a.title}
                </div>
