...
import { DevReviewWidget, NextSessionWidget } from './CrossSpaceWidgets'

export function renderWidget(key: WidgetKey): React.ReactNode {
  switch (key) {
    case 'todo':
      return <TaskListWidget mode="todo" />
    case 'doing':
      return <TaskListWidget mode="doing" />
    case 'overdue':
      return <TaskListWidget mode="overdue" />
    case 'week':
      return <WeekWidget />
    case 'notes':
      return <NoteCollectionWidget noteType="NOTE" />
    case 'notebook':
      return <NoteCollectionWidget noteType="DRAFT" />
    case 'ideas':
      return <NoteCollectionWidget noteType="IDEA" />
    case 'postit':
      return <PostItWall />
    case 'kpis':
      return <KpiWidget />
    ...
    case 'goal':
      return <GoalWidget />
    case 'devReview':
      return <DevReviewWidget />
    case 'nextSession':
      return <NextSessionWidget />
    default:
      return null
  }
}
