          ...
          <div className="qualiopi-criterion-actions" onClick={(e) => e.stopPropagation()}>
            ...
            {isExpanded && (
              <button
                ...
                onClick={async () => { if (await onConfirmDeleteCriterion()) onDeleteCriterion(criterion._id) }}
                title="Supprimer"
              >
