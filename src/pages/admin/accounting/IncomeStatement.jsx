...
// Regroupe les lignes détail (charges/produits) par préfixe à 2 chiffres
// (60, 61, 62 pour les charges ; 70, 71, 72… pour les produits) pour permettre l'expand par groupe.
function detailsByGroup(items) {
  const map = new Map()
...
function GroupSection({ title, totalLabel, groups, total, details, color }) {
        ...
        <table className="accounting-table">
          <tbody>
            {groups.map((g) => {
              ...
              return (
                <React.Fragment key={`grp-${g.group}`}>
                  <tr
                    style={{
