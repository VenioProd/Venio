...
export default function DraftQueue() {
  ...
  async function handleBulkValidate(ids) {
      ...
      <section className="accounting-card">
        ...
        {loading ? (
          ...
          <div className="accounting-empty">
            ...
            Tout est à jour !
            <div className="hint">
              Aucune écriture en attente de validation pour ces filtres.
            </div>
          </div>
        ) : (
              ...
              {entries.map((e) => {
                ...
                return (
                  <tr key={e._id}>
                    ...
                    <td>
                      {e.sourceSlug ? (
                        <span className="accounting-badge source-external">
                          {e.sourceSlug}
                        </span>
                      ) : (
        ...
        {total > filters.limit && (
          <div className="accounting-pagination">
            ...
            <span
              style={{ alignSelf: 'center', color: 'rgba(255,255,255,0.6)' }}
            >
