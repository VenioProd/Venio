...
// Indique si un solde est "normal" (positif) selon le type du compte.
// ACTIF / CHARGE  → solde débiteur attendu (donc balance > 0 = normal vert).
// PASSIF / PRODUIT / CAPITAUX → solde créditeur attendu (donc balance < 0 = normal vert).
function balanceColor(type, balance) {
...
export default function TrialBalance() {
  ...
  // Premier run automatique sans filtres
  useEffect(() => {
    runQuery()
  ...
  // On insère des séparateurs visuels par classe
