...
// Libellés humains des classes pour l'affichage groupé
const CLASS_LABELS = {
  1: 'Capitaux',
  2: 'Immobilisations',
  3: 'Stocks',
...
function groupByClass(items) {
  ...
  const groups = Array.from(map.entries()).map(([cls, lines]) => ({
    cls,
              ...
              <div>
                ...
                {actifGroups.length === 0 ? (
                  ...
                  <table className="accounting-table">
                    <tbody>
                      {actifGroups.map((g) => (
                        <React.Fragment key={`actif-${g.cls}`}>
              ...
              <div>
                ...
                {passifGroups.length === 0 && resultExercise === 0 ? (
                  ...
                  <table className="accounting-table">
                    <tbody>
                      {passifGroups.map((g) => (
                        <React.Fragment key={`passif-${g.cls}`}>
                          <tr style={{ background: 'rgba(255,255,255,0.04)' }}>
                            <td
                              colSpan={2}
                              style={{
