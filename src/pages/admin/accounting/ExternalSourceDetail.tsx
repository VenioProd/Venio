...
function txStatusClass(status: ExternalTransactionStatus): string {
...
function parseTagsInput(value: string | undefined | null): string[] {
  if (!value) return []
  return String(value)
    .split(',')
    .map((s) => s.trim())
            ...
            <div className="accounting-form">
              ...
              <div className="accounting-form-field full">
                ...
                >
                  <input
                    ...
                    onChange={(e) => setEdit({ ...edit, autoValidateAll: e.target.checked })}
                    style={{ marginRight: 8 }}
                  />
              ...
              <div className="accounting-form-field">
                ...
                <input
                  ...
                  onChange={(e) => setEdit({ ...edit, rateLimitPerMin: e.target.value })}
                />
              </div>
              <div className="accounting-form-field">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEdit({ ...edit, defaultJournalCode: e.target.value.toUpperCase() })
                  }
                />
              </div>
              <div className="accounting-form-field">
                ...
                <input
                  ...
                  onChange={(e) => setEdit({ ...edit, defaultCustomerAccount: e.target.value })}
                />
              </div>
              <div className="accounting-form-field">
                ...
                <input
                  ...
                  onChange={(e) => setEdit({ ...edit, defaultRevenueAccount: e.target.value })}
                />
              </div>
              <div className="accounting-form-field">
                ...
                <input
                  ...
                  onChange={(e) => setEdit({ ...edit, defaultExpenseAccount: e.target.value })}
                />
              </div>
              <div className="accounting-form-field">
                ...
                <input
                  ...
                  onChange={(e) => setEdit({ ...edit, defaultBankAccount: e.target.value })}
                />
              </div>
            </div>

            <div style={{ display: 'flex', gap: 10, marginTop: 16, flexWrap: 'wrap' }}>
              <button className="portal-button" onClick={handleSaveInfo} disabled={saving}>
        ...
        <section className="accounting-card">
          <div className="accounting-toolbar">
            ...
            <input
              ...
              onChange={(e) => setTxFilters({ ...txFilters, externalId: e.target.value })}
