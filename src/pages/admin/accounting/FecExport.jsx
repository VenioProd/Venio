...
export default function FecExport() {
  ...
  // Dates effectives (priorité aux dates manuelles, sinon celles de l'exercice)
    ...
    >
      ...
      <section className="accounting-card" style={{ marginBottom: 16 }}>
        <div className="accounting-message info" style={{ margin: 0 }}>
          ...
          <span className="accounting-badge validated">VALIDATED</span>{' '}
          ou <span className="accounting-badge locked">LOCKED</span> — les brouillons
      ...
      <section className="accounting-card" style={{ marginBottom: 16 }}>
        ...
        >
          ...
          significatives de la période sont au statut <strong>VALIDATED</strong>{' '}
          ou <strong>LOCKED</strong>. Les brouillons sont automatiquement exclus du
          FEC ; un export incomplet pourrait être contesté par l'administration en
          cas de contrôle.
        </div>
      </section>
