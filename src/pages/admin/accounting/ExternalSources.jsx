...
export default function ExternalSources() {
  ...
  return (
    ...
    >
      ...
      {success && !credentials && (
        <div className="accounting-message success">{success}</div>
      )}
            ...
            <div className="accounting-form-field full">
              <label style={{ textTransform: 'none', letterSpacing: 0, fontSize: '0.88rem' }}>
                <input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, autoValidateAll: e.target.checked })
                  }
                  style={{ marginRight: 8 }}
                />
          ...
          <div className="accounting-form">
            ...
            <div className="accounting-form-field">
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, defaultCustomerAccount: e.target.value })
                }
              />
            </div>
            <div className="accounting-form-field">
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, defaultRevenueAccount: e.target.value })
                }
              />
            </div>
            <div className="accounting-form-field">
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, defaultExpenseAccount: e.target.value })
                }
              />
            </div>
            <div className="accounting-form-field">
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, defaultBankAccount: e.target.value })
                }
              />
            </div>
          </div>
      ...
      {credentials && (
        ...
        >
          ...
          >
            ...
            >
              ⚠ Cette clé et ce secret ne seront PLUS jamais affichés. Stockez-les
              immédiatement de manière sécurisée (gestionnaire de mots de passe, coffre-fort).
              {credentials.warning && (
