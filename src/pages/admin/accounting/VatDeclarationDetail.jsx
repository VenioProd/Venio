...
export default function VatDeclarationDetail() {
  ...
  return (
    <AccountingLayout
      title={title}
      subtitle={declaration ? `Régime : ${declaration.regime || '—'} · Périodicité : ${declaration.periodicity || '—'}` : null}
      actions={
        ...
        <>
          ...
          <section className="accounting-card" style={{ marginBottom: 16 }}>
            ...
            >
              ...
              <div>
                ...
                <div>
                  <span
                    className={`accounting-badge ${isSubmitted ? 'validated' : 'draft'}`}
                  >
          ...
          {declaration.notes && declaration.notes.trim() && (
            <section className="accounting-card">
              ...
              <p style={{ whiteSpace: 'pre-wrap', color: 'rgba(255,255,255,0.85)', margin: 0 }}>
                {declaration.notes}
              </p>
            </section>
          )}
        ...
        >
          ...
          >
            ...
            <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.9rem' }}>
              ...
              Vous pouvez optionnellement renseigner la référence retournée par
              impots.gouv.fr.
            </p>
