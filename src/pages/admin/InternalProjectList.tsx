  ...
  return (
    ...
    <div className="portal-container">
      ...
      {selectedMission && (
        <MissionDetailDrawer
          ctx={{
            missions, selectedMission, setSelectedMission, user, isSuperAdmin,
            expandedStep, setExpandedStep, stepAssigneeInputs, setStepAssigneeInputs,
            deliverableInputs, setDeliverableInputs, uploadingMission, fileInputRefs,
            missionStepInputs, setMissionStepInputs,
            handleParticipantUpdate, handleStepDescUpdate, handleMissionStatusUpdate,
            handleMissionToggleStep, handleMissionAddStep, handleMissionDateUpdate,
            handleDeliverableAdd, handleDeliverableToggle, handleDeliverableDelete,
            handleMissionFileUpload, handleMissionFileOpen, handleMissionFileDelete,
            handleMissionProgressUpdate, apiFetch, setMissions, showToast,
          }}
        />
      )}
